            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="padding-bottom: 5%;">
                        <form class="post" role="form" method="post" action="addSM.php">    
                            <div class="control-group">
                                <label class="control-label col-sm-11 col-sm-offset-1" for="Title">First Name</label>                      
                            ...
                            <div class="control-group">
                                <label class="control-label col-sm-11 col-sm-offset-1" for="Title">Last Name</label>                      
                                <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="control-group">
                                <label class="control-label col-sm-11 col-sm-offset-1" for="Title">Store Assigned</label>                      
                                <div class="col-sm-10 col-sm-offset-1">
                                    <input type="text" class="form-control" name="storeassigned">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label col-sm-11 col-sm-offset-1 input" for="Price">Email</label>
                                <div class="col-sm-10 col-sm-offset-1">
                            ...
                            <div class="control-group">
                                <label class="control-label col-sm-11 col-sm-offset-1 input" for="Price">Salary</label>
                                <div class="col-sm-10 col-sm-offset-1">
