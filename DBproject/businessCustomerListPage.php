...
<html>
    <head>
        <title>Business Customer List Page</title>
        <meta charset="UTF-8">
    ...
    <body>
            ...
            <div class="dropdown col-md-3">
                ...
                <span class="caret"></span>
                  ...
                  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="customerList.php">Individual Customer</a></li>
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="#">Business Customer</a></li>
                  </ul>    
            </div>    
            
            <!-- 加客户 -->
            <div class="col-md-2 col-md-offset-7">    
                <a href="addBusinessCustomerPage.php" class="btn btn-block btn-primary">Add Customer</a> 
            </div>
        </div>  
        ...
        <div class="col-md-10 col-md-offset-1" style="margin-top: 1%; padding-top:2%; padding-bottom:2%;">
            <div class="panel panel-default">
                <div class="panel-heading" style="color: #0099CC"><strong>Business Customer List</strong></div>
                <table class="table table-bordered" align="center">
                        <tr style="font-weight: bold !important;">
                            ...
                            <th class="col-sm-1">Annual Income</th>
                            <th class="col-sm-2">Order History</th>       
                        </tr>
                        <?php
                            include 'conn.php';
                            $Page_size=100;
                            $result1=mysqli_query($conn,"SELECT * FROM customer NATURAL JOIN businesscustomer WHERE customerType='business'");
                            ...
                            $sql="SELECT * FROM customer NATURAL JOIN businesscustomer WHERE customerType='business' LIMIT $offset,$Page_size";
                        ...
                        <tr>
                            ...
                            <td><?php echo $row['grossAnnualIncome']?></td>
